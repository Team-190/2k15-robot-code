...
public class RobotMap {
	...
	public static void init() {
        ...
        winchMotor = new Talon(1);
        LiveWindow.addActuator("Winch", "Motor", (Talon) winchMotor);
        
        winchLimitSwitch = new DigitalInput(11);
        LiveWindow.addSensor("Winch", "Limit Switch", winchLimitSwitch);
