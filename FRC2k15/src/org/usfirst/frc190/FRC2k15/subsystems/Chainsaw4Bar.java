...
public class Chainsaw4Bar extends PIDSubsystem implements LimitedPIDSubsystem {
	...
	public final double collectPositionNarrow = 1.236;//1.192
	public final double collectPositionWide = 1.42;
	public final double scoringPosition = 1.820;
	public final double storagePosition = 1.248;//1.192; //1.236
	public final double wideCollectPosition = 1.6;
