...
public class Chainsaw4Bar extends PIDSubsystem implements LimitedPIDSubsystem {
	...
	public final double humanPosition = 0.290;
	public final double collectPosition = 0.500;
	public final double scoringPosition = 0.683;
	public final double storagePosition = 0.500;
	...
	public Chainsaw4Bar() {
        ...
        super("Chainsaw4Bar", -20.0, 0.0, 5.0);
