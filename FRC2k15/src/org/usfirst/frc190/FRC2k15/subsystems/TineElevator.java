...
public class TineElevator extends PIDSubsystem implements LimitedPIDSubsystem{
	// TODO: Update These
	public final double bottomPosition = 93.4;
	public final double topPosition = 0.0;
	public final double humanLoadPosition = 0.0;
	public final double aboveStorePosition = 63.6;
	public final double storePosition = 76;
