...
public class TineElevator extends PIDSubsystem implements LimitedPIDSubsystem{
	// TODO: Update These
	public final double bottomPosition = 101.814;
	public final double topPosition = 17.2;
	public final double humanLoadPosition = 0.0;
	public final double aboveStorePosition = 61.0;
	public final double storePosition = 83;
	public final double midPosition = 40.0;
