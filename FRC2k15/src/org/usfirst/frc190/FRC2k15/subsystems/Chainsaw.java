...
public class Chainsaw extends PIDSubsystem {
    ...
    public double hookSetPoint[] = {0.0,0.1,0.3,0.5,0.6,0.7,1.0};//keeps track of PID setpoints for different hooklevels
...
currentHookPosition = setPos(pos);
    ...
    private byte setPos(byte temppos){//keeps currentHookPosition within the bounds of array
    	if(temppos<0)
