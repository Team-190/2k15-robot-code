...
public class Chainsaw extends PIDSubsystem {
	...
	//The values below are used to calculate all the positions for chainsaw
	
	//This is the encoder reading when the first hook is just about to engage with the first totes
	private double initialOffset = 8.885;
	...
	//This is the position used for tines operation
	//In this position, all the hooks are fully contained behind the chainsaw
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        ...
        for(int i = 0; i < hookSetPoint.length/2; i++){
        	hookSetPoint[i*2+1] = toteOffset + i*toteHookDistance;
