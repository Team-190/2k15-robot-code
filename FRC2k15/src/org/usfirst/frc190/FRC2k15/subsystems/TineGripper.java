...
public class TineGripper extends PIDSubsystem implements LimitedPIDSubsystem{
	// TODO: Update these
	public final double containerPosition = 15;
	public final double narrowTotePosition = 46.5;
	public final double wideTotePosition = 0.0;
	public final double openPosition = 11.9;
	public final double fullyClosedPosition = 54.0;
	public final double almostClosedPosition = 44.3;
