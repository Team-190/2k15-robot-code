...
import org.usfirst.frc190.FRC2k15.commands.GyroUpdate;
...
public class Robot extends IterativeRobot {
    ...
    public static GyroUpdate gyroUpdate;
	/**
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        disableDriveTrain();
        gyroUpdate = new GyroUpdate();
        gyroUpdate.setRunWhenDisabled(true);//sets the gyro to continue updating when robot is disabled
        gyroUpdate.start();//starts the gyro task
	}
