 ...
 *
 */
public class  FourBarScoringPosition extends Command {
	
	private boolean holdPosition = false;

    public FourBarScoringPosition() {
 ...
 // Called just before this Command runs the first time
    protected void initialize() {
        ...
        Robot.chainsaw4Bar.setSetpoint(1.0);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZE
        Robot.chainsaw4Bar.setSetpoint(Robot.chainsaw4Bar.scoringPosition);
        VoiceCmds.speak(VoiceCmds.s_fourBarScoring);
    }
