 ...
 *
 */
public class DriveDistDirectionSteady extends Command {
	...
	private double kRotate = -0.05;

	public DriveDistDirectionSteady() {
	...
	public DriveDistDirectionSteady(double inSpeed, double inDist, double inDir) {
		Speed = inSpeed;
		Dist = inDist;
		Dir = inDir;
...
//		Robot.drivetrain.MecanumDrivePolar(Speed, Dir, 0);
		...
		correction = Robot.drivetrain.getHeading()*kRotate;
		
		Robot.drivetrain.MecanumDrivePolar(Speed, Dir, correction);
	}
	...
	protected boolean isFinished() {
		...
		return Robot.oi.interruptBtn.get() || (Robot.drivetrain.getDistance() >= Dist);
	}
