...
public class  TinesNarrowTote extends Command {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
        ...
        Robot.tineGripper.setSetpoint(0.25);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZE
	        Robot.tineGripper.setSetpoint(Robot.tineGripper.narrowTotePosition);
	    }
