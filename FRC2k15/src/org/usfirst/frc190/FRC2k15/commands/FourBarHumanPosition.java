 ...
 *
 */
public class  FourBarHumanPosition extends Command {
	
	private boolean holdPosition = false;

    public FourBarHumanPosition() {
    ...
    protected void initialize() {
        ...
        Robot.chainsaw4Bar.setSetpoint(0.0);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZE
        Robot.chainsaw4Bar.setSetpoint(Robot.chainsaw4Bar.humanPosition);
        VoiceCmds.speak(VoiceCmds.s_fourBarHuman);
    }
