...
public class  TinesWideTote extends Command {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
        ...
        Robot.tineGripper.setSetpoint(0.6);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZE
	        Robot.tineGripper.setSetpoint(Robot.tineGripper.wideTotePosition);
	    }
