 ...
 *
 */
public class  TineElevatorHumanLoad extends Command {

    public TineElevatorHumanLoad() {
    ...
    protected void initialize() {
        ...
        Robot.tineElevator.setSetpoint(0.25);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZE
        Robot.tineElevator.setSetpoint(Robot.tineElevator.humanLoadPosition); 
    }
    ...
    protected void end() {
    	if(Robot.tineElevator.getTopLimit() || Robot.tineElevator.getLowerLimit()){
