 ...
 *
 */
public class  TineElevatorTop extends Command {

    public TineElevatorTop() {
    ...
    protected void initialize() {
        ...
        Robot.tineElevator.setSetpoint(1.0);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZE
        Robot.tineElevator.setSetpoint(Robot.tineElevator.topPosition); 
    }
