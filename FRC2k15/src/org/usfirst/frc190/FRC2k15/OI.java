...
public class OI {
	...
	public OI() {
		...
		SmartDashboard
				.putData("GetIntoAutoPosition", new GetIntoAutoPosition());

		SmartDashboard.putData("DriveUntilToteDetectedAuto",
				new DriveUntilToteDetectedAuto());
		...
		SmartDashboard.putData("TineElevatorHumanLoad",
				new TineElevatorHumanLoad());

		SmartDashboard.putData("FourBarScoringPosition",
				new FourBarScoringPosition());

		SmartDashboard.putData("FourBarStoragePosition",
				new FourBarStoragePosition());

		SmartDashboard.putData("FourBarHumanPosition",
				new FourBarHumanPosition());

		SmartDashboard.putData("ToteAlign", new ToteAlign());

		SmartDashboard.putData("ResetEncoders", new ResetEncoders());

		SmartDashboard.putData("DriveDistTestSequence",
				new DriveDistTestSequence());

		SmartDashboard.putData("ResetChainsaw", new ResetChainsaw());

		SmartDashboard.putData("IncreaseChainsawPosition",
				new IncreaseChainsawPosition());

		SmartDashboard.putData("DecreaseChainsawPosition",
				new DecreaseChainsawPosition());

		SmartDashboard.putData("DeliverStack", new DeliverStack());

		SmartDashboard.putData("ChainsawDeliverStackPosition",
				new ChainsawDeliverStackPosition());

		SmartDashboard
				.putData("AutoYellowToteStack", new AutoYellowToteStack());

		SmartDashboard.putData("AutoDriveForward", new AutoDriveForward());

		SmartDashboard
				.putData("AutoStealContainers", new AutoStealContainers());

		// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
		Joystick temp = new Joystick(3);
		if (temp.getRawButton(12)) {
			Oper1 = temp;
			Oper2 = new Joystick(4);
		} else {
			Oper2 = temp;
			Oper1 = new Joystick(4);
		}
		...
		oFourBarScoring.whenPressed(new FourBarScoringPosition());
		oFourBarStoring = new JoystickButton(Oper2, 10);
		oFourBarStoring.whenPressed(new FourBarStoragePosition());
		oFourBarHuman = new JoystickButton(Oper2, 9);
		oFourBarHuman.whenPressed(new FourBarHumanPosition());
		oFourBarManualIn = new JoystickButton(Oper2, 8);
		oFourBarManualIn.whileHeld(new FourBarManualIn());
		oFourBarManualOut = new JoystickButton(Oper2, 7);
		oFourBarManualOut.whileHeld(new FourBarManualOut());
