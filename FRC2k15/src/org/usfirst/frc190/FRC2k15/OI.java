...
public class OI {
	...
	public JoystickButton fourBarTestA;
	public JoystickButton fourBarTestB;
	public JoystickButton fourBarTestC;
	public JoystickButton fourBarTestD;
	//end Remove
...
//		oChainsawReset.whenPressed(new ResetChainsaw());
		//TODO: Remove this section
		fourBarTestA = new JoystickButton(secondaryJoystick, 1);
		fourBarTestA.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar, 0.12));
		fourBarTestB = new JoystickButton(secondaryJoystick, 2);
		fourBarTestB.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar, 0.093));
		fourBarTestC = new JoystickButton(secondaryJoystick,3);
		fourBarTestC.whileHeld(new LimitedManualCommand(Robot.chainsaw4Bar, -0.1));
		fourBarTestD = new JoystickButton(secondaryJoystick,4);
		fourBarTestD.whileHeld(new LimitedManualCommand(Robot.chainsaw4Bar, 0.1));
		//end Remove
	}
