...
//        secondaryJoystick = new Joystick(1);
		...
		//This code initializes the buttons for the new OI 2015
		console = new Joystick(2);
        ...
        chainsaw4BarStorePositionBtn.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar, Robot.chainsaw4Bar.storagePosition , 0.2, -0.2, false));
        chainsaw4BarScorePositionBtn = new JoystickButton(console, 15);
        chainsaw4BarScorePositionBtn.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar, Robot.chainsaw4Bar.collectPositionWide, 0.2, -0.2, false));
        chainsaw4BarStackPositionBtn = new JoystickButton(console, 17);
        chainsaw4BarStackPositionBtn.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar, Robot.chainsaw4Bar.scoringPosition, 0.2, -0.2, false));
//        chainsaw4BarScorePositionBtn = new JoystickButton(console, 15);
...
//        humanPlayerSequencePlusBtn.whenPressed(new DoNothing());
        humanPlayerSequenceMinusBtn = new JoystickButton(console, 12);
        humanPlayerSequenceMinusBtn.whenPressed(new AutoTotePickupWideDriving());
        humanPlayerSequencePlusBtn = new JoystickButton(console, 13);
		...
		//Note: Always delete the robot-builder generated code mentioned above.
        ...
        SmartDashboard.putData("Tines Above Store Position", new TinesAboveStorePosition());

        SmartDashboard.putData("Tines Closed", new TinesClosed());

        SmartDashboard.putData("Tines Almost Closed", new TinesAlmostClosed());

        SmartDashboard.putData("Jraj Auto", new JrajAuto());
        ...
        SmartDashboard.putData("DisableWings", new DisableWings());

        SmartDashboard.putData("AutoWingsOfDoom", new AutoWingsOfDoom());

        SmartDashboard.putData("FireWingsSequence", new FireWingsSequence());

        SmartDashboard.putData("AutoTotePickupWideDriving", new AutoTotePickupWideDriving());

        SmartDashboard.putData("RetractStands", new RetractStands());
