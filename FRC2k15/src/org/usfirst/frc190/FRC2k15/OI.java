...
public class OI {
	...
	public JoystickButton oPotDisplay;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
		...
		oFourBarScoring.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar,Robot.chainsaw4Bar.scoringPosition, true));
		oFourBarStoring = new JoystickButton(Oper2, 10);
		oFourBarStoring.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar,Robot.chainsaw4Bar.storagePosition, true));
		oFourBarHuman = new JoystickButton(Oper2, 9);
		oFourBarHuman.whenPressed(new LimitedPIDSubsystemSetpointCommand(Robot.chainsaw4Bar,Robot.chainsaw4Bar.humanPosition, true));
		...
		oPotDisplay = new JoystickButton(Oper1,8);
		oPotDisplay.whileHeld(new DisplayPot(RobotMap.chainsaw4BarfourBarPot));
	}
