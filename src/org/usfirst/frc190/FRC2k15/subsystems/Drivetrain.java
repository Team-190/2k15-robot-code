...
public class Drivetrain extends Subsystem {
    ...
    public void driveSpeed(double forwards, double sideways, double rot) {
    	robotDrive41.mecanumDrive_Cartesian(forwards, sideways, rot, gyro.getAngle());
    }
